...
import com.opr.finshred.selenium.CapitalIQ;
import com.opr.finshred.selenium.JPMorgan;
import com.opr.finshred.selenium.Zacks;
...
public class AutoDownloadDialog extends javax.swing.JDialog {
    ...
    private Thread capitalIQthread;
    private CapitalIQ capitalIQ;
    private Thread jpmThread;
    private JPMorgan jPMorgan;
    private Zacks zacks;
    private Thread zacksThread;
    ...
    private void startDownload() {
        // this is how JPM used to be parse. But not anymore.
...
//        });
        ...
        jPMorgan = null;
        zacks = null;
        if (Settings.getSettings().isCapIQ()) {
            capitalIQ = new CapitalIQ();
            capitalIQthread = new Thread(capitalIQ);
            capitalIQthread.start();
        } else if (Settings.getSettings().isJPM()) {
            jPMorgan = new JPMorgan();
            jpmThread = new Thread(jPMorgan);
            jpmThread.start();
        } else if (Settings.getSettings().isZacks()) {
            zacks = new Zacks();
            zacksThread = new Thread(zacks);
            zacksThread.start();
        }
    }
    ...
    private void stopDownload() {
        ...
        if (ret == JOptionPane.YES_OPTION) {
            if (capitalIQ != null) {
                capitalIQ.setStop(true);
            }
            if (jPMorgan != null) {
                jPMorgan.setStop(true);
            }
            if (zacks != null) {
                zacks.setStop(true);
            }
